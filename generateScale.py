'''
This file contains data such as all of the music notes, and the formulas for different
scales. It also determines the notes in a scale based on the key and mode.
'''
